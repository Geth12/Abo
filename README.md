local Allowed = loadstring(game:HttpGet("https://raw.githubusercontent.com/Bekonader/bahahaha/main/Bahahah", true))()
...
sexTab:AddParagraph("comeing soon","it just comeing soon!")
